  ...
  async performCalculations() {
    ...
    btnPotential.addEventListener("click", async() => {
      ...
      calcDiv.innerHTML = `
        ...
        <form method="POST" action='${this.url_server}:8000/potential/v2/result' id="potentialMainForm">
    ...
    btnEvaluation.addEventListener("click", () => {
      ...
      <form method="POST" action='${this.url_server}:8000/existing/v1/result' id="existingMainForm">
