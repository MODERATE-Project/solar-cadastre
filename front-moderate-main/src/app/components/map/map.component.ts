...
export class MapComponent implements OnInit {
  ...
  private geoserverURL = "https://re-modulees.five.es:8443/";
  ...
  public activatePotential() {
    this.showTables.viewContainerRef.clear();
    const componentRef = this.showTables.viewContainerRef.createComponent(SolarPotentialComponent);
  ...
  initMap(){
    ...
    const buildingCadastralLayer = L.tileLayer.wms(this.buildingCadastral, {
      format: 'image/png',
      transparent: true,
      layers: 'Remodulees:cadastral_buildings',
      tileSize: 3080,
      crs: crs25830
    });
